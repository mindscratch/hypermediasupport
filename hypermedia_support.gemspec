...
Gem::Specification.new do |s|
  ...
  s.name              = 'hypermedia_support'
  s.version           = '0.0.1'
  s.date              = '2012-03-15'
  s.rubyforge_project = 'hypermedia_support'
  ...
  s.files = %w[
    ...
    README.md
    Rakefile
    hypermedia_support.gemspec
    lib/hypermedia_support.rb
    lib/hypermedia_support/error.rb
    lib/hypermedia_support/paging_support.rb
  ]
  # = MANIFEST =
